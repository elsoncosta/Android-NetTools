 ...
 */
public class ImagesMemoryCacheActivity extends ListActivity {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        ImageAdapter adapter = new ImageAdapter(getApplicationContext(), URLS, ImageCache.CacheMode.MEMORY);
